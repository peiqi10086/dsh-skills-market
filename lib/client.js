window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"invoke.model": "AI 调用",
			"invoke.user": "用户调用",
			"invoke.modelOffBadge": "已禁用 AI 调用",
			"invoke.userOffBadge": "已禁用用户调用",
			"action.uninstall": "卸载",
		...
		const en = {
			...
			"invoke.model": "AI invocation",
			"invoke.user": "User invocation",
			"invoke.modelOffBadge": "AI invocation disabled",
			"invoke.userOffBadge": "User invocation disabled",
		...
		*/
		...
		function SkillRow({ item, store, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: `dshs-row${item.manageable ? "" : " readonly"}${fullyEnabled ? "" : " dimmed"}`,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							!item.modelInvocable ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "dshs-badge",
								children: t("invoke.modelOffBadge")
							}) : null,
							!item.userInvocable ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "dshs-badge",
								children: t("invoke.userOffBadge")
							}) : null
						]
					}),
					...
					item.manageable ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(InvocationToggle, {
