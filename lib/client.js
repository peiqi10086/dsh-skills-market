					...
					item.manageable ? confirming ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								onClick: () => {
									store.runRowAction(rowKey, "set-invocation", {
										name: item.dir,
										level: item.level,
		...
		*/
		...
		function apply(ctx) {
			...
			function openManager() {
				...
				console.log("[skills-market] openManager: betterSidebar =", bs === void 0 ? "absent" : `present(version=${String(bs.version)}) openTab=${typeof bs.openTab}`);
