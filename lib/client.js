...
`;
		...
		*/
		...
		function apply(ctx) {
			...
			*/
			function collapseBetterSidebarPanel() {
				const buttons = document.querySelectorAll("button");
				for (const button of buttons) if (button.querySelector("rect[x=\"10.5\"][width=\"2.75\"]") !== null) {
					button.click();
					return true;
				}
				return false;
